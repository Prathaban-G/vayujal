...
<ol class="breadcrumb mt-5  ">
    ...
    <li class="breadcrumb-item active " aria-current="page"><a href="{{ route('superadmin.users.index') }}" >Admin Management</a></li>
    ...
    <div class="form d-flex me-1 w-25 ">
        ...
        <button class="btn btn-secondary float-end py-1 px-3" id="addPage"><i class="fa fa-plus"></i><a  style="color: inherit;
            text-decoration: inherit;" href="{{ route('superadmin.admins.create') }}">Add</a></button>
...
<div class="container-fluid shadow-sm border-top border-primary border-2 p-3" style="background-color: #fff;">
    <div class="row table-customer px-2 py-2">
        <div class="col-12">
            <div class="h4 mb-3">Admin Details</div>
    ...
    <tr>
        ...
        <td>
        <a href="{{ route('superadmin.admins.edit', $user->id) }}" class="btn btn-success px-4 py-1 ms-1 me-1">Edit</a>
    ...
    @endforeach
    @if ($users->where('type', 'admin')->count() === 0)
    <tr>
