...
<div class="main">
    <div class="container-fluid">
        <div class="row pt-2">
            <div class="col-lg-7"> <nav aria-label="breadcrumb">
                <ol class="breadcrumb mt-3">
                    <li class="breadcrumb-item"><a href="{{ url('home') }}"><i class="fa fa-home"></i></a></li>
                    <li class="breadcrumb-item"><a href="{{ url('users') }}">User Management</a></li>
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ url('addUsers') }}">Add User</a>
                    </li>
                </ol>
                
            </nav></div><div class="col-lg-5"><div class="container-fluid d-flex justify-content-end">
    ...
    @if ($errors->any())
    <div class="alert alert-danger alert-dismissible fade show position-fixed  end-0 mt-3 me-3" style="top:100px;" role="alert" id="errorAlert">
        <ul class="mb-0">
...
<script>
    ...
    <div class="row px-3 py-1">
        ...
        <div class="row" style="display: none;">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-12">
                    <h6 class="text-start text-dark p-2" >User Name <span style="color: red;">*</span></h6>
                </div>
                <div class="col-lg-8 col-sm-12">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-12">
                    <h6 class="text-start text-dark p-2">Email Id <span style="color: red;">*</span></h6>
                </div>
                <div class="col-lg-8 col-sm-12">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-12">
                    <h6 class="text-start text-dark p-2">Password <span style="color: red;">*</span></h6>
                </div>
                <div class="col-lg-8 col-sm-12">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-12">
                    <h6 class="text-start text-dark p-2">Mobile No</h6>
                </div>
                <div class="col-lg-8 col-sm-12">
                    <input type="number" class="form-control" id="cmobile" placeholder="Enter Mobile Number" name="mobileno" value="{{ old('mobileno', isset($user) ? $user->mobileno : '') }}">
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-sm-12">
            <div class="row">
                <div class="col-lg-4 col-sm-12">
                    <h6 class="text-start text-dark p-2" >Project Name <span style="color: red;">*</span></h6>
                </div>
                <div class="col-lg-8 col-sm-12">
                    <input type="text" class="form-control" placeholder="Enter Project Name" id="proname" name="projectname" value="{{ old('projectname', isset($user) ? $user->projectname : '') }}" required>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-sm-12">
                    <h6 class="text-start text-dark p-2">City</h6>
                </div>
                <div class="col-lg-8 col-sm-12">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-12">
                    <h6 class="text-start text-dark p-2">Zip code</h6>
                </div>
                <div class="col-lg-8 col-sm-12">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-12">
                    <h6 class="text-start text-dark p-2">State</h6>
                </div>
                <div class="col-lg-8 col-sm-12">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-12">
                    <h6 class="text-start text-dark p-2">Address</h6>
                </div>
                <div class="col-lg-8 col-sm-12">
    ...
    <div class="row mt-3">
        <div class="d-flex justify-content-center">
            ...
            <button type="reset" class="btn btn-secondary text-white ms-5 px-3 py-1" id="clearInput">
